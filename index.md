...
[`vignette("databentoR")`](https://www.sebastianstoeckl.com/databentoR/articles/databentoR.md)
walks through the rest: symbology, batch jobs, reference data, and exact
...
reports what databentoR will assign, and the live test suite checks that
table against
...
[`vignette("equivalence")`](https://www.sebastianstoeckl.com/databentoR/articles/equivalence.md)
documents that and the five remaining differences.
